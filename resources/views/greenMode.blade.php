...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/greenMode.css') }}" />
  </head>
  <body>
    <div class="header">
      <div class="logo">
      <a href="{{ route('home') }}">
        <img src="image/logoGreen.png" alt="Logo" />
      </a>
        sho-cart
      </div>
      <div class="user-icon" onclick="toggleOverlay('overlay')">
        <img src="image/userGreen.png" alt="user" />
      </div>
    </div>
    <div class="container">
      ...
      <div class="calendar">
        <div class="calendar-header">
          <button class="prev-month">
            <img src="image/backGreen.png" alt="">
          </button>
          ...
          <button class="next-month">
            <img src="image/nextGreen.png" alt="">
          </button>
        </div>
        <div class="days">
...
<div class="overlay" id="overlay">
  <div class="user-menu" onclick="event.stopPropagation()">
      <div class="user-menu-header">
          ...
          <div class="user-icon">
              <img src="image/userOpenGreen.png" alt="User">
          </div>
      </div>
      <div class="user-menu-body">
          <div class="menu-item-top">
              <span style="font-size:24px;">
                  <img src="image/themeGreen.png" alt="">
              </span>
              <button class onclick="toggleOverlay('theme-overlay')">Change Theme</button>
          </div>
          <div class="menu-item-bottom">
              <span style="font-size:24px;">
                  <img src="image/logoutGreen.png" alt="">
              </span>
  ...
  <div class="overlay" id="theme-overlay" onclick="toggleOverlay('theme-overlay')">
    <div class="theme-menu" onclick="event.stopPropagation()">
      ...
      <button class="theme-option-bottom" onclick="changeTheme('blueMode')">
          <span>
  ...
  <div class="overlay" id="receipt-overlay" onclick="toggleOverlay('receipt-overlay')">
    <div class="receipt" onclick="event.stopPropagation()">
      <img class="close" src="image/closeGreen.png" alt="" onclick="toggleOverlay('receipt-overlay')">
      <img class="receiptLogo" src="image/logoGreen.png" alt="">
      <h1>RECEIPT</h1>
      <div class="date">
